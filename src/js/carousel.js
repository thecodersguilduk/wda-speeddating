;(function () {
  ...
  function rotateCarousel (el, dir) {
    ...
    let currentBullet = el.getElementsByClassName('carousel-bullet')[index]
    ...
    if (nextItem) {
      ...
      if (dir === 'next') {
        el.getElementsByClassName('carousel-items')[0].firstElementChild.classList.add('is-active')
        el.getElementsByClassName('carousel-bullets')[0].firstElementChild.classList.add('is-active')
      } else {
        el.getElementsByClassName('carousel-items')[0].lastElementChild.classList.add('is-active')
        el.getElementsByClassName('carousel-bullets')[0].lastElementChild.classList.add('is-active')
      }
    }
  }
  ...
  if (carousels.length > 0) {
    for (let i = 0; i < carousels.length; i++) {
      ...
      let carouselContainer = carousel.getElementsByClassName('carousel-items')[0]
      ...
      carouselContainer.parentNode.insertBefore(bulletsContainer, carouselContainer.nextSibling)
      for (let i = 0; i < items.length; i++) {
        // Add data attributes
        ...
        carousel.getElementsByClassName('carousel-bullets')[0].appendChild(bullet)
      }
      // Add is-active class to first carousel item and bullet
      items[0].classList.add('is-active')
      let bullets = carousel.getElementsByClassName('carousel-bullet')
